...
void ZZ_App( TString myMethodList = "" ) 
{   
#ifdef __CINT__
   ...
   std::cout << std::endl;
   std::cout << "==> Start ZZ_App" << std::endl;
...
*/
   ...
   //   
   TFile *input(0);
   TString fname = "/home/hep/wilken/Weights/CMSSW_4_2_8_patch3/src/UserCode/wilken/CSVShapeCorr/ZZ.root"; 
	double lumi = 100.0;
   ...
   //   var2 = userVar1 - userVar2;
      ...
      if (Use["TMlpANN"      ])   histNnT    ->Fill( reader->EvaluateMVA( "TMlpANN method"       ) );
	   ...
	   BDTvalue = reader->EvaluateMVA( "BDT method"           );
		   histMattBdt    ->Fill( BDTvalue,ZZ_weight );
		   histTMVABdt    ->Fill( BDTvalue,ZZ_weight );
	   }
...
hMjj_OpenSelection->Fill(Hmass,ZZ_weight);
hMmumu_OpenSelection->Fill(Zmass,ZZ_weight);
hPtjj_OpenSelection->Fill(Hpt,ZZ_weight);
hPtmumu_OpenSelection->Fill(Zpt,ZZ_weight);
hCSV0_OpenSelection->Fill(CSV0,ZZ_weight);
hCSV1_OpenSelection->Fill(CSV1,ZZ_weight);
hdphiVH_OpenSelection->Fill(DeltaPhiHV,ZZ_weight);
hdetaJJ_OpenSelection->Fill(DetaJJ,ZZ_weight);
hUnweightedEta_OpenSelection->Fill(UnweightedEta,ZZ_weight);
hPtmu0_OpenSelection->Fill(mu0pt,ZZ_weight);
	   hHt_OpenSelection->Fill(Ht,ZZ_weight);
	   hCircularity_OpenSelection->Fill(EvntShpCircularity,ZZ_weight);
	   hCHFb0_OpenSelection->Fill(jetCHF0, ZZ_weight);
	   hCHFb1_OpenSelection->Fill(jetCHF1, ZZ_weight);
	   hPtbalZH_OpenSelection->Fill(PtbalZH, ZZ_weight);
	   hPtmu1_OpenSelection->Fill(mu1pt, ZZ_weight);
	   hPFRelIsomu0_OpenSelection->Fill(muonPFiso0, ZZ_weight);
	   hPFRelIsomu1_OpenSelection->Fill(muonPFiso1, ZZ_weight);
	   hNjets_OpenSelection->Fill(nJets, ZZ_weight);
	   hRMSeta_OpenSelection->Fill(RMS_eta, ZZ_weight);
	   hStaDeveta_OpenSelection->Fill(EtaStandDev, ZZ_weight);
	   hdphiJJ_vect_OpenSelection->Fill(DphiJJ, ZZ_weight);
	   hCentrality_OpenSelection->Fill(Centrality, ZZ_weight);
	   hEventPt_OpenSelection->Fill(EventPt, ZZ_weight);
	   hAngle_OpenSelection->Fill(Angle, ZZ_weight);
	   hSphericity_OpenSelection->Fill(EvntShpSphericity, ZZ_weight);
	   hAplanarity_OpenSelection->Fill(EvntShpAplanarity, ZZ_weight);
	   hIsotropy_OpenSelection->Fill(EvntShpIsotropy, ZZ_weight);
	   hDphiDetajj_OpenSelection->Fill(DphiJJ, DetaJJ, ZZ_weight);
   ...
   // --- Write histograms
   TFile *target  = new TFile( "TMVApp_ZZ.root","RECREATE" );
...
treeWithBDT->Delete();
   ...
   std::cout << "==> ZZ_App is done!" << endl << std::endl;

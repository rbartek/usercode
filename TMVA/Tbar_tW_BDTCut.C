...
void Tbar_tW_BDTCut( TString myMethodList = "" ) 
{   
#ifdef __CINT__
   ...
   std::cout << std::endl;
   std::cout << "==> Start Tbar_tW_BDTCut" << std::endl;
...
*/
   ...
   //   
   TFile *input(0);
   TString fname = "/home/hep/wilken/taus/CMSSW_4_4_2_patch8/src/UserCode/wilken/V21/Tbar_tW.root"; 
	double lumi = 4.457;
	Double_t  Tbar_tW_weight = lumi/(lumiTtWb/2.0); //Tbar_tW_TuneZ2_7TeV_pythia6_tauola
   ...
   //   var2 = userVar1 - userVar2;
      ...
      if (Use["TMlpANN"      ])   histNnT    ->Fill( reader->EvaluateMVA( "TMlpANN method"       ) );
	   ...
	   BDTvalue = reader->EvaluateMVA( "BDT method"           );
		   histMattBdt    ->Fill( BDTvalue,Tbar_tW_weight*Trigweight*B2011PUweight );
		   histTMVABdt    ->Fill( BDTvalue,Tbar_tW_weight*Trigweight*B2011PUweight );
	   }
	  ...
	  // std::cout << "Ht is "<< Ht << endl;
	   if(BDTvalue>-1.50){
NpassBDT++;
hMjj_OpenSelection->Fill(Hmass,Tbar_tW_weight*Trigweight*B2011PUweight );
hMmumu_OpenSelection->Fill(Emumass,Tbar_tW_weight*Trigweight*B2011PUweight );
hPtjj_OpenSelection->Fill(Hpt,Tbar_tW_weight*Trigweight*B2011PUweight );
hPtmumu_OpenSelection->Fill(Zpt,Tbar_tW_weight*Trigweight*B2011PUweight );
hCSV0_OpenSelection->Fill(CSV0,Tbar_tW_weight*Trigweight*B2011PUweight );
hCSV1_OpenSelection->Fill(CSV1,Tbar_tW_weight*Trigweight*B2011PUweight );
hdphiVH_OpenSelection->Fill(DeltaPhiHV,Tbar_tW_weight*Trigweight*B2011PUweight );
hdetaJJ_OpenSelection->Fill(DetaJJ,Tbar_tW_weight*Trigweight*B2011PUweight );
hUnweightedEta_OpenSelection->Fill(UnweightedEta,Tbar_tW_weight*Trigweight*B2011PUweight );
hPtmu0_OpenSelection->Fill(lep0pt,Tbar_tW_weight*Trigweight*B2011PUweight );
	   hHt_OpenSelection->Fill(Ht,Tbar_tW_weight*Trigweight*B2011PUweight );
	   hCircularity_OpenSelection->Fill(EvntShpCircularity,Tbar_tW_weight*Trigweight*B2011PUweight );
	   hCHFb0_OpenSelection->Fill(jetCHF0, Tbar_tW_weight*Trigweight*B2011PUweight );
	   hCHFb1_OpenSelection->Fill(jetCHF1, Tbar_tW_weight*Trigweight*B2011PUweight );
	   hPtbalZH_OpenSelection->Fill(PtbalZH, Tbar_tW_weight*Trigweight*B2011PUweight );
	   hPtmu1_OpenSelection->Fill(lep1pt, Tbar_tW_weight*Trigweight*B2011PUweight );
	   hPFRelIsomu0_OpenSelection->Fill(lep_pfCombRelIso0, Tbar_tW_weight*Trigweight*B2011PUweight );
	   hPFRelIsomu1_OpenSelection->Fill(lep_pfCombRelIso1, Tbar_tW_weight*Trigweight*B2011PUweight );
	   hNjets_OpenSelection->Fill(nJets, Tbar_tW_weight*Trigweight*B2011PUweight );
	   hRMSeta_OpenSelection->Fill(RMS_eta, Tbar_tW_weight*Trigweight*B2011PUweight );
	   hStaDeveta_OpenSelection->Fill(EtaStandDev, Tbar_tW_weight*Trigweight*B2011PUweight );
	   hdphiJJ_vect_OpenSelection->Fill(DphiJJ, Tbar_tW_weight*Trigweight*B2011PUweight );
	   hCentrality_OpenSelection->Fill(Centrality, Tbar_tW_weight*Trigweight*B2011PUweight );
	   hEventPt_OpenSelection->Fill(EventPt, Tbar_tW_weight*Trigweight*B2011PUweight );
	   hAngleEMU_OpenSelection->Fill(AngleEMU, Tbar_tW_weight*Trigweight*B2011PUweight );
	   hSphericity_OpenSelection->Fill(EvntShpSphericity, Tbar_tW_weight*Trigweight*B2011PUweight );
	   hAplanarity_OpenSelection->Fill(EvntShpAplanarity, Tbar_tW_weight*Trigweight*B2011PUweight );
	   hIsotropy_OpenSelection->Fill(EvntShpIsotropy, Tbar_tW_weight*Trigweight*B2011PUweight );
		   hDphiDetajj_OpenSelection->Fill(DphiJJ, DetaJJ, Tbar_tW_weight*Trigweight*B2011PUweight );
		   hMte_OpenSelection->Fill(Mte, Tbar_tW_weight*Trigweight*B2011PUweight );
		   hMtmu_OpenSelection->Fill(Mtmu, Tbar_tW_weight*Trigweight*B2011PUweight );
		   hdPhiHMET_OpenSelection->Fill(dPhiHMET, Tbar_tW_weight*Trigweight*B2011PUweight );
		   hDphiemu_OpenSelection->Fill(DeltaPhijetMETmin, Tbar_tW_weight*Trigweight*B2011PUweight );
		   hdelRjj_OpenSelection->Fill(delRjj, Tbar_tW_weight*Trigweight*B2011PUweight );
		   hdelRemu_OpenSelection->Fill(delRemu, Tbar_tW_weight*Trigweight*B2011PUweight );
		   hDphiZMET_OpenSelection->Fill(DphiZMET, Tbar_tW_weight*Trigweight*B2011PUweight );
		   hDphiemu_OpenSelection->Fill(Dphiemu, Tbar_tW_weight*Trigweight*B2011PUweight );
		   hDeltaPhijetMETmin_OpenSelection->Fill(DeltaPhijetMETmin, Tbar_tW_weight*Trigweight*B2011PUweight );
		   hAngleHemu_OpenSelection->Fill(AngleHemu, Tbar_tW_weight*Trigweight*B2011PUweight );
		   hProjVisT_OpenSelection->Fill(ProjVisT, Tbar_tW_weight*Trigweight*B2011PUweight );
		   htopMass_OpenSelection->Fill(topMass, Tbar_tW_weight*Trigweight*B2011PUweight );
		   htopPt_OpenSelection->Fill(topPt, Tbar_tW_weight*Trigweight*B2011PUweight );
		   hVMt_OpenSelection->Fill(Mt, Tbar_tW_weight*Trigweight*B2011PUweight );
		   hZmassSVD_OpenSelection->Fill(ZmassSVD, Tbar_tW_weight*Trigweight*B2011PUweight );
		   hZmassSVDnegSol_OpenSelection->Fill(ZmassSVDnegSol, Tbar_tW_weight*Trigweight*B2011PUweight );
		   hZmass_OpenSelection->Fill(Zmass, Tbar_tW_weight*Trigweight*B2011PUweight );
		   hZmassNegInclu_OpenSelection->Fill(ZmassNegInclu, Tbar_tW_weight*Trigweight*B2011PUweight );
...
std::cout << "Number of Events: "<< Nevents << " Events passed BDT " << NpassBDT<< endl;
   ...
   // --- Write histograms
   TFile *target  = new TFile( "BDTCut_Tbar_tW.root","RECREATE" );
...
treeWithBDT->Delete();
   ...
   std::cout << "==> Tbar_tW_BDTCut is done!" << endl << std::endl;

...
void TTJets60M_App( TString myMethodList = "" ) 
{   
#ifdef __CINT__
   ...
   std::cout << std::endl;
   std::cout << "==> Start TTJets60M_App" << std::endl;
...
*/
   ...
   //   
   TFile *input(0);
   TString fname = "/home/hep/wilken/Weights/CMSSW_4_2_8_patch3/src/UserCode/wilken/CSVShapeCorr/TTJets_60M.root"; 
	double lumi = 100.0;
	Double_t  TTJets60M_weight = lumi/(lumiTT/2.0) ;  //TTJets_TuneZ2_7TeV-madgraph-tauola_60M
   ...
   //   var2 = userVar1 - userVar2;
      ...
      if (Use["TMlpANN"      ])   histNnT    ->Fill( reader->EvaluateMVA( "TMlpANN method"       ) );
	   if (Use["BDT"          ]) {
		   ...
		   histMattBdt    ->Fill( BDTvalue,TTJets60M_weight );
		   histTMVABdt    ->Fill( BDTvalue,TTJets60M_weight );
	   }
...
hMjj_OpenSelection->Fill(Hmass,TTJets60M_weight);
hMmumu_OpenSelection->Fill(Zmass,TTJets60M_weight);
hPtjj_OpenSelection->Fill(Hpt,TTJets60M_weight);
hPtmumu_OpenSelection->Fill(Zpt,TTJets60M_weight);
hCSV0_OpenSelection->Fill(CSV0,TTJets60M_weight);
hCSV1_OpenSelection->Fill(CSV1,TTJets60M_weight);
hdphiVH_OpenSelection->Fill(DeltaPhiHV,TTJets60M_weight);
hdetaJJ_OpenSelection->Fill(DetaJJ,TTJets60M_weight);
hUnweightedEta_OpenSelection->Fill(UnweightedEta,TTJets60M_weight);
hPtmu0_OpenSelection->Fill(mu0pt,TTJets60M_weight);
	   hHt_OpenSelection->Fill(Ht,TTJets60M_weight);
	   hCircularity_OpenSelection->Fill(EvntShpCircularity,TTJets60M_weight);
	   hCHFb0_OpenSelection->Fill(jetCHF0, TTJets60M_weight);
	   hCHFb1_OpenSelection->Fill(jetCHF1, TTJets60M_weight);
	   hPtbalZH_OpenSelection->Fill(PtbalZH, TTJets60M_weight);
	   hPtmu1_OpenSelection->Fill(mu1pt, TTJets60M_weight);
	   hPFRelIsomu0_OpenSelection->Fill(muonPFiso0, TTJets60M_weight);
	   hPFRelIsomu1_OpenSelection->Fill(muonPFiso1, TTJets60M_weight);
	   hNjets_OpenSelection->Fill(nJets, TTJets60M_weight);
	   hRMSeta_OpenSelection->Fill(RMS_eta, TTJets60M_weight);
	   hStaDeveta_OpenSelection->Fill(EtaStandDev, TTJets60M_weight);
	   hdphiJJ_vect_OpenSelection->Fill(DphiJJ, TTJets60M_weight);
	   hCentrality_OpenSelection->Fill(Centrality, TTJets60M_weight);
	   hEventPt_OpenSelection->Fill(EventPt, TTJets60M_weight);
	   hAngle_OpenSelection->Fill(Angle, TTJets60M_weight);
	   hSphericity_OpenSelection->Fill(EvntShpSphericity, TTJets60M_weight);
	   hAplanarity_OpenSelection->Fill(EvntShpAplanarity, TTJets60M_weight);
	   hIsotropy_OpenSelection->Fill(EvntShpIsotropy, TTJets60M_weight);
	   hDphiDetajj_OpenSelection->Fill(DphiJJ, DetaJJ, TTJets60M_weight);
   ...
   TFile *target  = new TFile( "TMVApp_TTJets60M.root","RECREATE" );
...
treeWithBDT->Delete();
   ...
   std::cout << "==> TTJets60M_App is done!" << endl << std::endl;

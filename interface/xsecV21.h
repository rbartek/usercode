...
const double numWJ = 6.91162640000000000e+07;
const double numZJH = 1.17941837500000000e+06;
const double numZJL = 3.69806400000000000e+07;
const double numTT = 5.39229920000000000e+07;
//TTbar_M60
//TTbar 3803462.25;
const double numTs = 1111111111;
const double numTt = 1111111111111;
const double numTtW = 8.14323000000000000e+05;
const double numTsb = 11111111111;
const double numTtb = 1992339.75;
const double numTtWb = 8.09924000000000000e+05;
const double numWW = 4.29172300000000000e+06;
const double numWZ = 4.39651450000000000e+06;
...
const double numZZ = 2.47941075000000000e+06;

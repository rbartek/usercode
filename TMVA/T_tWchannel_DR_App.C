...
void T_tWchannel_DR_App( TString myMethodList = "" ) 
{   
#ifdef __CINT__
   ...
   std::cout << std::endl;
   std::cout << "==> Start T_tWchannel_DR_App" << std::endl;
...
if (Use["BDTD"])          histBdtD    = new TH1F( "MVA_BDTD",          "MVA_BDTD",          nbin, -0.8, 0.8 );
   ...
   //   
   TFile *input(0);
   TString fname = "/home/hep/wilken/Weights/CMSSW_4_2_8_patch3/src/UserCode/wilken/CSVShapeCorr/T_tWchannel_DR.root"; 
	double lumi = 100.0;
	Double_t  T_tWchannel_DR_weight = lumi/(lumiTtW/2.0) ; //T_TuneZ2_tW-channel-DR_7TeV-powheg-tauola
   ...
   //   var2 = userVar1 - userVar2;
      ...
      if (Use["TMlpANN"      ])   histNnT    ->Fill( reader->EvaluateMVA( "TMlpANN method"       ) );
	   if (Use["BDT"          ]) {
		   ...
		   histMattBdt    ->Fill( BDTvalue,T_tWchannel_DR_weight );
		   histTMVABdt    ->Fill( BDTvalue,T_tWchannel_DR_weight );
	   }
...
hMjj_OpenSelection->Fill(Hmass,T_tWchannel_DR_weight);
hMmumu_OpenSelection->Fill(Zmass,T_tWchannel_DR_weight);
hPtjj_OpenSelection->Fill(Hpt,T_tWchannel_DR_weight);
hPtmumu_OpenSelection->Fill(Zpt,T_tWchannel_DR_weight);
hCSV0_OpenSelection->Fill(CSV0,T_tWchannel_DR_weight);
hCSV1_OpenSelection->Fill(CSV1,T_tWchannel_DR_weight);
hdphiVH_OpenSelection->Fill(DeltaPhiHV,T_tWchannel_DR_weight);
hdetaJJ_OpenSelection->Fill(DetaJJ,T_tWchannel_DR_weight);
hUnweightedEta_OpenSelection->Fill(UnweightedEta,T_tWchannel_DR_weight);
hPtmu0_OpenSelection->Fill(mu0pt,T_tWchannel_DR_weight);
	   hHt_OpenSelection->Fill(Ht,T_tWchannel_DR_weight);
	   hCircularity_OpenSelection->Fill(EvntShpCircularity,T_tWchannel_DR_weight);
	   hCHFb0_OpenSelection->Fill(jetCHF0, T_tWchannel_DR_weight);
	   hCHFb1_OpenSelection->Fill(jetCHF1, T_tWchannel_DR_weight);
	   hPtbalZH_OpenSelection->Fill(PtbalZH, T_tWchannel_DR_weight);
	   hPtmu1_OpenSelection->Fill(mu1pt, T_tWchannel_DR_weight);
	   hPFRelIsomu0_OpenSelection->Fill(muonPFiso0, T_tWchannel_DR_weight);
	   hPFRelIsomu1_OpenSelection->Fill(muonPFiso1, T_tWchannel_DR_weight);
	   hNjets_OpenSelection->Fill(nJets, T_tWchannel_DR_weight);
	   hRMSeta_OpenSelection->Fill(RMS_eta, T_tWchannel_DR_weight);
	   hStaDeveta_OpenSelection->Fill(EtaStandDev, T_tWchannel_DR_weight);
	   hdphiJJ_vect_OpenSelection->Fill(DphiJJ, T_tWchannel_DR_weight);
	   hCentrality_OpenSelection->Fill(Centrality, T_tWchannel_DR_weight);
	   hEventPt_OpenSelection->Fill(EventPt, T_tWchannel_DR_weight);
	   hAngle_OpenSelection->Fill(Angle, T_tWchannel_DR_weight);
	   hSphericity_OpenSelection->Fill(EvntShpSphericity, T_tWchannel_DR_weight);
	   hAplanarity_OpenSelection->Fill(EvntShpAplanarity, T_tWchannel_DR_weight);
	   hIsotropy_OpenSelection->Fill(EvntShpIsotropy, T_tWchannel_DR_weight);
	   hDphiDetajj_OpenSelection->Fill(DphiJJ, DetaJJ, T_tWchannel_DR_weight);
   ...
   TFile *target  = new TFile( "TMVApp_T_tWchannel_DR.root","RECREATE" );
...
treeWithBDT->Delete();
   ...
   std::cout << "==> T_tWchannel_DR_App is done!" << endl << std::endl;

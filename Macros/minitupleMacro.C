...
void minitupleMacro(){
   ...
   */
    ...
    TFile *H115_Zbb = TFile::Open("/Users/rachelwilken/Documents/CMS/Zbb/RecreateAnalysis/AddVar.root");
...
// ********************************************************************
    ...
    TH1F* hjetCSV3_H115_Zbb		= (TH1F*) H115_Zbb->Get("jetCSV3");
    TH1F* hjetPt3_H115_Zbb		= (TH1F*) H115_Zbb->Get("jetPt3");
    TH1F* hnJets_H115_Zbb			= (TH1F*) H115_Zbb->Get("hnJets");
    TH1F* hnMuons_H115_Zbb		= (TH1F*) H115_Zbb->Get("hnMuons");
    TH1F* hjetPt1_H115_Zbb		= (TH1F*) H115_Zbb->Get("jetPt1");
    TH1F* hjetPt2_H115_Zbb		= (TH1F*) H115_Zbb->Get("jetPt2");
	...
	// Histogram
	hjetCSV3_H115_Zbb->SetTitle("Third Jet ordered in CSV");
	hjetCSV3_H115_Zbb->GetXaxis()->SetRangeUser(0,1);
	hjetCSV3_H115_Zbb->GetXaxis()->SetTitle("CSV");
	hjetCSV3_H115_Zbb->GetYaxis()->SetTitle(" ");
	hjetCSV3_H115_Zbb->SetLineColor(kBlue);
	hjetCSV3_H115_Zbb->Draw("hist");
	//gStyle->SetOptStat(kFALSE);
	plot = directory+"CSV3"+suffixps;
	c1->Print(plot);
	c1->Clear();
	
	hjetPt3_H115_Zbb->SetTitle("Jet with third highest Pt");
	hjetPt3_H115_Zbb->GetXaxis()->SetTitle("p_{T} (GeV)");
	hjetPt3_H115_Zbb->GetYaxis()->SetTitle(" ");
	hjetPt3_H115_Zbb->SetLineColor(kBlue);
	hjetPt3_H115_Zbb->Draw("hist");
	//gStyle->SetOptStat(kFALSE);
	...
	hjetPt2_H115_Zbb->SetTitle("Jet with second highest Pt");
	hjetPt2_H115_Zbb->GetXaxis()->SetTitle("p_{T} (GeV)");
	hjetPt2_H115_Zbb->GetYaxis()->SetTitle(" ");
	hjetPt2_H115_Zbb->SetLineColor(kBlue);
	hjetPt2_H115_Zbb->Draw("hist");
	//gStyle->SetOptStat(kFALSE);
	plot = directory+"JetPt2"+suffixps;
	c1->Print(plot);
	c1->Clear();

	hjetPt1_H115_Zbb->SetTitle("Jet with highest Pt");
	hjetPt1_H115_Zbb->GetXaxis()->SetTitle("p_{T} (GeV)");
	hjetPt1_H115_Zbb->GetYaxis()->SetTitle(" ");
	hjetPt1_H115_Zbb->SetLineColor(kBlue);
	hjetPt1_H115_Zbb->Draw("hist");
	//gStyle->SetOptStat(kFALSE);
	...
	c1->Clear();	
	 ...
	 hCutFlow_H115_Zbb->GetXaxis()->SetBinLabel(1,"HLT");
	 hCutFlow_H115_Zbb->GetXaxis()->SetBinLabel(2,"PreSelection");
	 hCutFlow_H115_Zbb->GetXaxis()->SetBinLabel(3,"p_{T}(jj)");
	 hCutFlow_H115_Zbb->GetXaxis()->SetBinLabel(4,"p_{T}(Z)");
	 hCutFlow_H115_Zbb->GetXaxis()->SetBinLabel(5,"CSV1");
	 hCutFlow_H115_Zbb->GetXaxis()->SetBinLabel(6,"CSV2");
	 hCutFlow_H115_Zbb->GetXaxis()->SetBinLabel(7,"#Delta#phi");
	 hCutFlow_H115_Zbb->GetXaxis()->SetBinLabel(8,"N_{aj}");
	 hCutFlow_H115_Zbb->GetXaxis()->SetBinLabel(9,"M_{jj}");	

...
void WZ_App( TString myMethodList = "" ) 
{   
#ifdef __CINT__
   ...
   std::cout << std::endl;
   std::cout << "==> Start WZ_App" << std::endl;
...
*/
   ...
   //   
   TFile *input(0);
   TString fname = "/home/hep/wilken/Weights/CMSSW_4_2_8_patch3/src/UserCode/wilken/CSVShapeCorr/WZ.root";
	double lumi = 100.0;
   ...
   //   var2 = userVar1 - userVar2;
      ...
      if (Use["TMlpANN"      ])   histNnT    ->Fill( reader->EvaluateMVA( "TMlpANN method"       ) );
	   if (Use["BDT"          ]) {
		   ...
		   histMattBdt    ->Fill( BDTvalue,WZ_weight );
		   histTMVABdt    ->Fill( BDTvalue,WZ_weight );
	   }
...
hMjj_OpenSelection->Fill(Hmass,WZ_weight);
hMmumu_OpenSelection->Fill(Zmass,WZ_weight);
hPtjj_OpenSelection->Fill(Hpt,WZ_weight);
hPtmumu_OpenSelection->Fill(Zpt,WZ_weight);
hCSV0_OpenSelection->Fill(CSV0,WZ_weight);
hCSV1_OpenSelection->Fill(CSV1,WZ_weight);
hdphiVH_OpenSelection->Fill(DeltaPhiHV,WZ_weight);
hdetaJJ_OpenSelection->Fill(DetaJJ,WZ_weight);
hUnweightedEta_OpenSelection->Fill(UnweightedEta,WZ_weight);
hPtmu0_OpenSelection->Fill(mu0pt,WZ_weight);
	   hHt_OpenSelection->Fill(Ht,WZ_weight);
	   hCircularity_OpenSelection->Fill(EvntShpCircularity,WZ_weight);
	   hCHFb0_OpenSelection->Fill(jetCHF0, WZ_weight);
	   hCHFb1_OpenSelection->Fill(jetCHF1, WZ_weight);
	   hPtbalZH_OpenSelection->Fill(PtbalZH, WZ_weight);
	   hPtmu1_OpenSelection->Fill(mu1pt, WZ_weight);
	   hPFRelIsomu0_OpenSelection->Fill(muonPFiso0, WZ_weight);
	   hPFRelIsomu1_OpenSelection->Fill(muonPFiso1, WZ_weight);
	   hNjets_OpenSelection->Fill(nJets, WZ_weight);
	   hRMSeta_OpenSelection->Fill(RMS_eta, WZ_weight);
	   hStaDeveta_OpenSelection->Fill(EtaStandDev, WZ_weight);
	   hdphiJJ_vect_OpenSelection->Fill(DphiJJ, WZ_weight);
	   hCentrality_OpenSelection->Fill(Centrality, WZ_weight);
	   hEventPt_OpenSelection->Fill(EventPt, WZ_weight);
	   hAngle_OpenSelection->Fill(Angle, WZ_weight);
	   hSphericity_OpenSelection->Fill(EvntShpSphericity, WZ_weight);
	   hAplanarity_OpenSelection->Fill(EvntShpAplanarity, WZ_weight);
	   hIsotropy_OpenSelection->Fill(EvntShpIsotropy, WZ_weight);
	   hDphiDetajj_OpenSelection->Fill(DphiJJ, DetaJJ, WZ_weight);
   ...
   TFile *target  = new TFile( "TMVApp_WZ.root","RECREATE" );
...
treeWithBDT->Delete();
   ...
   std::cout << "==> WZ_App is done!" << endl << std::endl;

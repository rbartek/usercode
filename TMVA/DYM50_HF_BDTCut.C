...
void DYM50_HF_BDTCut( TString myMethodList = "" ) 
{   
#ifdef __CINT__
   ...
   std::cout << std::endl;
   std::cout << "==> Start DYM50_HF_BDTCut" << std::endl;
...
std::cout << "Number of Events: "<< Nevents << " Events passed BDT " << NpassBDT<< endl;
   ...
   // --- Write histograms
   TFile *target  = new TFile( "BDTCut_DYM50_HF.root","RECREATE" );
...
treeWithBDT->Delete();
   ...
   std::cout << "==> DYM50_HF_BDTCut is done!" << endl << std::endl;

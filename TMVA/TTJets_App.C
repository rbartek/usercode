...
void TTJets_App( TString myMethodList = "" ) 
{   
#ifdef __CINT__
   ...
   std::cout << std::endl;
   std::cout << "==> Start TTJets_App" << std::endl;
...
*/
   ...
   //   
   TFile *input(0);
   TString fname = "/home/hep/wilken/Weights/CMSSW_4_2_8_patch3/src/UserCode/wilken/CSVShapeCorr/TTJets.root"; 
	double lumi = 100.0;
	Double_t  TTJets_weight = lumi/((3803462.25/xsecbfTT)/2.0); //TTJets_TuneZ2_7TeV-madgraph-tauola
   ...
   //   var2 = userVar1 - userVar2;
      ...
      if (Use["TMlpANN"      ])   histNnT    ->Fill( reader->EvaluateMVA( "TMlpANN method"       ) );
	   if (Use["BDT"          ]) {
		   ...
		   histMattBdt    ->Fill( BDTvalue,TTJets_weight );
		   histTMVABdt    ->Fill( BDTvalue,TTJets_weight );
	   }
...
hMjj_OpenSelection->Fill(Hmass,TTJets_weight);
hMmumu_OpenSelection->Fill(Zmass,TTJets_weight);
hPtjj_OpenSelection->Fill(Hpt,TTJets_weight);
hPtmumu_OpenSelection->Fill(Zpt,TTJets_weight);
hCSV0_OpenSelection->Fill(CSV0,TTJets_weight);
hCSV1_OpenSelection->Fill(CSV1,TTJets_weight);
hdphiVH_OpenSelection->Fill(DeltaPhiHV,TTJets_weight);
hdetaJJ_OpenSelection->Fill(DetaJJ,TTJets_weight);
hUnweightedEta_OpenSelection->Fill(UnweightedEta,TTJets_weight);
hPtmu0_OpenSelection->Fill(mu0pt,TTJets_weight);
	   hHt_OpenSelection->Fill(Ht,TTJets_weight);
	   hCircularity_OpenSelection->Fill(EvntShpCircularity,TTJets_weight);
	   hCHFb0_OpenSelection->Fill(jetCHF0, TTJets_weight);
	   hCHFb1_OpenSelection->Fill(jetCHF1, TTJets_weight);
	   hPtbalZH_OpenSelection->Fill(PtbalZH, TTJets_weight);
	   hPtmu1_OpenSelection->Fill(mu1pt, TTJets_weight);
	   hPFRelIsomu0_OpenSelection->Fill(muonPFiso0, TTJets_weight);
	   hPFRelIsomu1_OpenSelection->Fill(muonPFiso1, TTJets_weight);
	   hNjets_OpenSelection->Fill(nJets, TTJets_weight);
	   hRMSeta_OpenSelection->Fill(RMS_eta, TTJets_weight);
	   hStaDeveta_OpenSelection->Fill(EtaStandDev, TTJets_weight);
	   hdphiJJ_vect_OpenSelection->Fill(DphiJJ, TTJets_weight);
	   hCentrality_OpenSelection->Fill(Centrality, TTJets_weight);
	   hEventPt_OpenSelection->Fill(EventPt, TTJets_weight);
	   hAngle_OpenSelection->Fill(Angle, TTJets_weight);
	   hSphericity_OpenSelection->Fill(EvntShpSphericity, TTJets_weight);
	   hAplanarity_OpenSelection->Fill(EvntShpAplanarity, TTJets_weight);
	   hIsotropy_OpenSelection->Fill(EvntShpIsotropy, TTJets_weight);
	   hDphiDetajj_OpenSelection->Fill(DphiJJ, DetaJJ, TTJets_weight);
...
treeWithBDT->Delete();
   ...
   std::cout << "==> TTJets_App is done!" << endl << std::endl;

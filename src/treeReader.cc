...
treeReader::initTree()
{
    ...
    fChain.SetBranchAddress("genTau", &genTau_mass, &b_genTau);
    fChain.SetBranchAddress("genTauMu", &genTauMu_mass, &b_genTauMu);
    fChain.SetBranchAddress("TkSharing", &TkSharing_HiggsCSVtkSharing, &b_TkSharing);
    fChain.SetBranchAddress("nRecoTaus", &nRecoTaus, &b_nRecoTaus);
    ...
    fChain.SetBranchAddress("tau_againstElectronMedium", tau_againstElectronMedium, &b_tau_againstElectronMedium);
    fChain.SetBranchAddress("tau_againstElectronMVA", tau_againstElectronMVA, &b_tau_againstElectronMVA);
    fChain.SetBranchAddress("genZtaumu", &genZtaumu, &b_genZtaumu);
    fChain.SetBranchAddress("genWmunu", &genWmunu, &b_genWmunu);
    fChain.SetBranchAddress("genWenu", &genWenu, &b_genWenu);
    fChain.SetBranchAddress("genZmumu", &genZmumu, &b_genZmumu);
    fChain.SetBranchAddress("genZee", &genZee, &b_genZee);
    fChain.SetBranchAddress("genZnunu", &genZnunu, &b_genZnunu);
    ...
    fChain.SetBranchAddress("hJet_jetArea", hJet_jetArea, &b_hJet_jetArea);
    ...
    fChain.SetBranchAddress("aJet_jetArea", aJet_jetArea, &b_aJet_jetArea);
    ...
    fChain.SetBranchAddress("hJet_genPtReg0", &hJet_genPtReg0, &b_hJet_genPtReg0);
    fChain.SetBranchAddress("hJet_genPtReg1", &hJet_genPtReg1, &b_hJet_genPtReg1);
    fChain.SetBranchAddress("newHiggsPt", &newHiggsPt, &b_newHiggsPt);
    fChain.SetBranchAddress("newHiggsMass", &newHiggsMass, &b_newHiggsMass);

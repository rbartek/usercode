 ...
 * Package   : TMVA                                                               *
 * Exectuable: Tbar_tWchannel_DR_App                                     *
 *                                                                                *
...
void Tbar_tWchannel_DR_App( TString myMethodList = "" ) 
{   
#ifdef __CINT__
   ...
   std::cout << std::endl;
   std::cout << "==> Start Tbar_tWchannel_DR_App" << std::endl;
...
*/
   ...
   for (std::map<std::string,int>::iterator it = Use.begin(); it != Use.end(); it++) {
	...
	treeWithBDT->Branch("Naj",&Naj, "Naj/IF");
   ...
   //   
   TFile *input(0);
   TString fname = "/home/hep/wilken/Weights/CMSSW_4_2_8_patch3/src/UserCode/wilken/CSVShapeCorr/Tbar_tWchannel_DR.root"; 
	double lumi = 100.0;
	Double_t  Tbar_tWchannel_DR_weight = lumi/(lumiTtWb/2.0); //Tbar_TuneZ2_tW-channel-DR_7TeV-powheg-tauola
   ...
   //   var2 = userVar1 - userVar2;
      ...
      if (Use["TMlpANN"      ])   histNnT    ->Fill( reader->EvaluateMVA( "TMlpANN method"       ) );
	   if (Use["BDT"          ]) {
		   ...
		   histMattBdt    ->Fill( BDTvalue,Tbar_tWchannel_DR_weight );
		   histTMVABdt    ->Fill( BDTvalue,Tbar_tWchannel_DR_weight );
	   }
...
hMjj_OpenSelection->Fill(Hmass,Tbar_tWchannel_DR_weight);
hMmumu_OpenSelection->Fill(Zmass,Tbar_tWchannel_DR_weight);
hPtjj_OpenSelection->Fill(Hpt,Tbar_tWchannel_DR_weight);
hPtmumu_OpenSelection->Fill(Zpt,Tbar_tWchannel_DR_weight);
hCSV0_OpenSelection->Fill(CSV0,Tbar_tWchannel_DR_weight);
hCSV1_OpenSelection->Fill(CSV1,Tbar_tWchannel_DR_weight);
hdphiVH_OpenSelection->Fill(DeltaPhiHV,Tbar_tWchannel_DR_weight);
hdetaJJ_OpenSelection->Fill(DetaJJ,Tbar_tWchannel_DR_weight);
hUnweightedEta_OpenSelection->Fill(UnweightedEta,Tbar_tWchannel_DR_weight);
hPtmu0_OpenSelection->Fill(mu0pt,Tbar_tWchannel_DR_weight);
	   hHt_OpenSelection->Fill(Ht,Tbar_tWchannel_DR_weight);
	   hCircularity_OpenSelection->Fill(EvntShpCircularity,Tbar_tWchannel_DR_weight);
	   hCHFb0_OpenSelection->Fill(jetCHF0, Tbar_tWchannel_DR_weight);
	   hCHFb1_OpenSelection->Fill(jetCHF1, Tbar_tWchannel_DR_weight);
	   hPtbalZH_OpenSelection->Fill(PtbalZH, Tbar_tWchannel_DR_weight);
	   hPtmu1_OpenSelection->Fill(mu1pt, Tbar_tWchannel_DR_weight);
	   hPFRelIsomu0_OpenSelection->Fill(muonPFiso0, Tbar_tWchannel_DR_weight);
	   hPFRelIsomu1_OpenSelection->Fill(muonPFiso1, Tbar_tWchannel_DR_weight);
	   hNjets_OpenSelection->Fill(nJets, Tbar_tWchannel_DR_weight);
	   hRMSeta_OpenSelection->Fill(RMS_eta, Tbar_tWchannel_DR_weight);
	   hStaDeveta_OpenSelection->Fill(EtaStandDev, Tbar_tWchannel_DR_weight);
	   hdphiJJ_vect_OpenSelection->Fill(DphiJJ, Tbar_tWchannel_DR_weight);
	   hCentrality_OpenSelection->Fill(Centrality, Tbar_tWchannel_DR_weight);
	   hEventPt_OpenSelection->Fill(EventPt, Tbar_tWchannel_DR_weight);
	   hAngle_OpenSelection->Fill(Angle, Tbar_tWchannel_DR_weight);
	   hSphericity_OpenSelection->Fill(EvntShpSphericity, Tbar_tWchannel_DR_weight);
	   hAplanarity_OpenSelection->Fill(EvntShpAplanarity, Tbar_tWchannel_DR_weight);
	   hIsotropy_OpenSelection->Fill(EvntShpIsotropy, Tbar_tWchannel_DR_weight);
	   hDphiDetajj_OpenSelection->Fill(DphiJJ, DetaJJ, Tbar_tWchannel_DR_weight);
   ...
   TFile *target  = new TFile( "TMVApp_Tbar_tWchannel_DR.root","RECREATE" );
...
treeWithBDT->Delete();
   ...
   std::cout << "==> Tbar_tWchannel_DR_App is done!" << endl << std::endl;

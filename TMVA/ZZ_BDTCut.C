...
void ZZ_BDTCut( TString myMethodList = "" ) 
{   
#ifdef __CINT__
   ...
   std::cout << std::endl;
   std::cout << "==> Start ZZ_BDTCut" << std::endl;
...
*/
   ...
   //   
   TFile *input(0);
   TString fname = "/home/hep/wilken/taus/CMSSW_4_4_2_patch8/src/UserCode/wilken/V21/ZZ.root"; 
	double lumi = 4.457;
	Double_t  ZZ_weight = lumi/(lumiZZ/2.0); //ZZ_TuneZ2_7TeV_pythia6_tauola
   ...
   //   var2 = userVar1 - userVar2;
      ...
      if (Use["TMlpANN"      ])   histNnT    ->Fill( reader->EvaluateMVA( "TMlpANN method"       ) );
	   ...
	   BDTvalue = reader->EvaluateMVA( "BDT method"           );
		   histMattBdt    ->Fill( BDTvalue,ZZ_weight*Trigweight*B2011PUweight );
		   histTMVABdt    ->Fill( BDTvalue,ZZ_weight*Trigweight*B2011PUweight );
	   }
	  ...
	  // std::cout << "Ht is "<< Ht << endl;
	   if(BDTvalue>-1.50){
NpassBDT++;
hMjj_OpenSelection->Fill(Hmass,ZZ_weight*Trigweight*B2011PUweight );
hMmumu_OpenSelection->Fill(Emumass,ZZ_weight*Trigweight*B2011PUweight );
hPtjj_OpenSelection->Fill(Hpt,ZZ_weight*Trigweight*B2011PUweight );
hPtmumu_OpenSelection->Fill(Zpt,ZZ_weight*Trigweight*B2011PUweight );
hCSV0_OpenSelection->Fill(CSV0,ZZ_weight*Trigweight*B2011PUweight );
hCSV1_OpenSelection->Fill(CSV1,ZZ_weight*Trigweight*B2011PUweight );
hdphiVH_OpenSelection->Fill(DeltaPhiHV,ZZ_weight*Trigweight*B2011PUweight );
hdetaJJ_OpenSelection->Fill(DetaJJ,ZZ_weight*Trigweight*B2011PUweight );
hUnweightedEta_OpenSelection->Fill(UnweightedEta,ZZ_weight*Trigweight*B2011PUweight );
hPtmu0_OpenSelection->Fill(lep0pt,ZZ_weight*Trigweight*B2011PUweight );
	   hHt_OpenSelection->Fill(Ht,ZZ_weight*Trigweight*B2011PUweight );
	   hCircularity_OpenSelection->Fill(EvntShpCircularity,ZZ_weight*Trigweight*B2011PUweight );
	   hCHFb0_OpenSelection->Fill(jetCHF0, ZZ_weight*Trigweight*B2011PUweight );
	   hCHFb1_OpenSelection->Fill(jetCHF1, ZZ_weight*Trigweight*B2011PUweight );
	   hPtbalZH_OpenSelection->Fill(PtbalZH, ZZ_weight*Trigweight*B2011PUweight );
	   hPtmu1_OpenSelection->Fill(lep1pt, ZZ_weight*Trigweight*B2011PUweight );
	   hPFRelIsomu0_OpenSelection->Fill(lep_pfCombRelIso0, ZZ_weight*Trigweight*B2011PUweight );
	   hPFRelIsomu1_OpenSelection->Fill(lep_pfCombRelIso1, ZZ_weight*Trigweight*B2011PUweight );
	   hNjets_OpenSelection->Fill(nJets, ZZ_weight*Trigweight*B2011PUweight );
	   hRMSeta_OpenSelection->Fill(RMS_eta, ZZ_weight*Trigweight*B2011PUweight );
	   hStaDeveta_OpenSelection->Fill(EtaStandDev, ZZ_weight*Trigweight*B2011PUweight );
	   hdphiJJ_vect_OpenSelection->Fill(DphiJJ, ZZ_weight*Trigweight*B2011PUweight );
	   hCentrality_OpenSelection->Fill(Centrality, ZZ_weight*Trigweight*B2011PUweight );
	   hEventPt_OpenSelection->Fill(EventPt, ZZ_weight*Trigweight*B2011PUweight );
	   hAngleEMU_OpenSelection->Fill(AngleEMU, ZZ_weight*Trigweight*B2011PUweight );
	   hSphericity_OpenSelection->Fill(EvntShpSphericity, ZZ_weight*Trigweight*B2011PUweight );
	   hAplanarity_OpenSelection->Fill(EvntShpAplanarity, ZZ_weight*Trigweight*B2011PUweight );
	   hIsotropy_OpenSelection->Fill(EvntShpIsotropy, ZZ_weight*Trigweight*B2011PUweight );
		   hDphiDetajj_OpenSelection->Fill(DphiJJ, DetaJJ, ZZ_weight*Trigweight*B2011PUweight );
		   hMte_OpenSelection->Fill(Mte, ZZ_weight*Trigweight*B2011PUweight );
		   hMtmu_OpenSelection->Fill(Mtmu, ZZ_weight*Trigweight*B2011PUweight );
		   hdPhiHMET_OpenSelection->Fill(dPhiHMET, ZZ_weight*Trigweight*B2011PUweight );
		   hDphiemu_OpenSelection->Fill(DeltaPhijetMETmin, ZZ_weight*Trigweight*B2011PUweight );
		   hdelRjj_OpenSelection->Fill(delRjj, ZZ_weight*Trigweight*B2011PUweight );
		   hdelRemu_OpenSelection->Fill(delRemu, ZZ_weight*Trigweight*B2011PUweight );
		   hDphiZMET_OpenSelection->Fill(DphiZMET, ZZ_weight*Trigweight*B2011PUweight );
		   hDphiemu_OpenSelection->Fill(Dphiemu, ZZ_weight*Trigweight*B2011PUweight );
		   hDeltaPhijetMETmin_OpenSelection->Fill(DeltaPhijetMETmin, ZZ_weight*Trigweight*B2011PUweight );
		   hAngleHemu_OpenSelection->Fill(AngleHemu, ZZ_weight*Trigweight*B2011PUweight );
		   hProjVisT_OpenSelection->Fill(ProjVisT, ZZ_weight*Trigweight*B2011PUweight );
		   htopMass_OpenSelection->Fill(topMass, ZZ_weight*Trigweight*B2011PUweight );
		   htopPt_OpenSelection->Fill(topPt, ZZ_weight*Trigweight*B2011PUweight );
		   hVMt_OpenSelection->Fill(Mt, ZZ_weight*Trigweight*B2011PUweight );
		   hZmassSVD_OpenSelection->Fill(ZmassSVD, ZZ_weight*Trigweight*B2011PUweight );
		   hZmassSVDnegSol_OpenSelection->Fill(ZmassSVDnegSol, ZZ_weight*Trigweight*B2011PUweight );
		   hZmass_OpenSelection->Fill(Zmass, ZZ_weight*Trigweight*B2011PUweight );
		   hZmassNegInclu_OpenSelection->Fill(ZmassNegInclu, ZZ_weight*Trigweight*B2011PUweight );
...
std::cout << "Number of Events: "<< Nevents << " Events passed BDT " << NpassBDT<< endl;
   ...
   // --- Write histograms
   TFile *target  = new TFile( "BDTCut_ZZ.root","RECREATE" );
...
treeWithBDT->Delete();
   ...
   std::cout << "==> ZZ_BDTCut is done!" << endl << std::endl;

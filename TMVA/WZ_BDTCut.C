...
void WZ_BDTCut( TString myMethodList = "" ) 
{   
#ifdef __CINT__
   ...
   std::cout << std::endl;
   std::cout << "==> Start WZ_BDTCut" << std::endl;
...
*/
   ...
   //   
   TFile *input(0);
   TString fname = "/home/hep/wilken/taus/CMSSW_4_4_2_patch8/src/UserCode/wilken/V21/WZ.root"; 
	double lumi = 4.457;
	Double_t  WZ_weight = lumi/(lumiWZ/2.0); //WZ_TuneZ2_7TeV_pythia6_tauola
   ...
   //   var2 = userVar1 - userVar2;
      ...
      if (Use["TMlpANN"      ])   histNnT    ->Fill( reader->EvaluateMVA( "TMlpANN method"       ) );
	   ...
	   BDTvalue = reader->EvaluateMVA( "BDT method"           );
		   histMattBdt    ->Fill( BDTvalue,WZ_weight*Trigweight*B2011PUweight );
		   histTMVABdt    ->Fill( BDTvalue,WZ_weight*Trigweight*B2011PUweight );
	   }
	  ...
	  // std::cout << "Ht is "<< Ht << endl;
	   if(BDTvalue>-1.50){
NpassBDT++;
hMjj_OpenSelection->Fill(Hmass,WZ_weight*Trigweight*B2011PUweight );
hMmumu_OpenSelection->Fill(Emumass,WZ_weight*Trigweight*B2011PUweight );
hPtjj_OpenSelection->Fill(Hpt,WZ_weight*Trigweight*B2011PUweight );
hPtmumu_OpenSelection->Fill(Zpt,WZ_weight*Trigweight*B2011PUweight );
hCSV0_OpenSelection->Fill(CSV0,WZ_weight*Trigweight*B2011PUweight );
hCSV1_OpenSelection->Fill(CSV1,WZ_weight*Trigweight*B2011PUweight );
hdphiVH_OpenSelection->Fill(DeltaPhiHV,WZ_weight*Trigweight*B2011PUweight );
hdetaJJ_OpenSelection->Fill(DetaJJ,WZ_weight*Trigweight*B2011PUweight );
hUnweightedEta_OpenSelection->Fill(UnweightedEta,WZ_weight*Trigweight*B2011PUweight );
hPtmu0_OpenSelection->Fill(lep0pt,WZ_weight*Trigweight*B2011PUweight );
	   hHt_OpenSelection->Fill(Ht,WZ_weight*Trigweight*B2011PUweight );
	   hCircularity_OpenSelection->Fill(EvntShpCircularity,WZ_weight*Trigweight*B2011PUweight );
	   hCHFb0_OpenSelection->Fill(jetCHF0, WZ_weight*Trigweight*B2011PUweight );
	   hCHFb1_OpenSelection->Fill(jetCHF1, WZ_weight*Trigweight*B2011PUweight );
	   hPtbalZH_OpenSelection->Fill(PtbalZH, WZ_weight*Trigweight*B2011PUweight );
	   hPtmu1_OpenSelection->Fill(lep1pt, WZ_weight*Trigweight*B2011PUweight );
	   hPFRelIsomu0_OpenSelection->Fill(lep_pfCombRelIso0, WZ_weight*Trigweight*B2011PUweight );
	   hPFRelIsomu1_OpenSelection->Fill(lep_pfCombRelIso1, WZ_weight*Trigweight*B2011PUweight );
	   hNjets_OpenSelection->Fill(nJets, WZ_weight*Trigweight*B2011PUweight );
	   hRMSeta_OpenSelection->Fill(RMS_eta, WZ_weight*Trigweight*B2011PUweight );
	   hStaDeveta_OpenSelection->Fill(EtaStandDev, WZ_weight*Trigweight*B2011PUweight );
	   hdphiJJ_vect_OpenSelection->Fill(DphiJJ, WZ_weight*Trigweight*B2011PUweight );
	   hCentrality_OpenSelection->Fill(Centrality, WZ_weight*Trigweight*B2011PUweight );
	   hEventPt_OpenSelection->Fill(EventPt, WZ_weight*Trigweight*B2011PUweight );
	   hAngleEMU_OpenSelection->Fill(AngleEMU, WZ_weight*Trigweight*B2011PUweight );
	   hSphericity_OpenSelection->Fill(EvntShpSphericity, WZ_weight*Trigweight*B2011PUweight );
	   hAplanarity_OpenSelection->Fill(EvntShpAplanarity, WZ_weight*Trigweight*B2011PUweight );
	   hIsotropy_OpenSelection->Fill(EvntShpIsotropy, WZ_weight*Trigweight*B2011PUweight );
		   hDphiDetajj_OpenSelection->Fill(DphiJJ, DetaJJ, WZ_weight*Trigweight*B2011PUweight );
		   hMte_OpenSelection->Fill(Mte, WZ_weight*Trigweight*B2011PUweight );
		   hMtmu_OpenSelection->Fill(Mtmu, WZ_weight*Trigweight*B2011PUweight );
		   hdPhiHMET_OpenSelection->Fill(dPhiHMET, WZ_weight*Trigweight*B2011PUweight );
		   hDphiemu_OpenSelection->Fill(DeltaPhijetMETmin, WZ_weight*Trigweight*B2011PUweight );
		   hdelRjj_OpenSelection->Fill(delRjj, WZ_weight*Trigweight*B2011PUweight );
		   hdelRemu_OpenSelection->Fill(delRemu, WZ_weight*Trigweight*B2011PUweight );
		   hDphiZMET_OpenSelection->Fill(DphiZMET, WZ_weight*Trigweight*B2011PUweight );
		   hDphiemu_OpenSelection->Fill(Dphiemu, WZ_weight*Trigweight*B2011PUweight );
		   hDeltaPhijetMETmin_OpenSelection->Fill(DeltaPhijetMETmin, WZ_weight*Trigweight*B2011PUweight );
		   hAngleHemu_OpenSelection->Fill(AngleHemu, WZ_weight*Trigweight*B2011PUweight );
		   hProjVisT_OpenSelection->Fill(ProjVisT, WZ_weight*Trigweight*B2011PUweight );
		   htopMass_OpenSelection->Fill(topMass, WZ_weight*Trigweight*B2011PUweight );
		   htopPt_OpenSelection->Fill(topPt, WZ_weight*Trigweight*B2011PUweight );
		   hVMt_OpenSelection->Fill(Mt, WZ_weight*Trigweight*B2011PUweight );
		   hZmassSVD_OpenSelection->Fill(ZmassSVD, WZ_weight*Trigweight*B2011PUweight );
		   hZmassSVDnegSol_OpenSelection->Fill(ZmassSVDnegSol, WZ_weight*Trigweight*B2011PUweight );
		   hZmass_OpenSelection->Fill(Zmass, WZ_weight*Trigweight*B2011PUweight );
		   hZmassNegInclu_OpenSelection->Fill(ZmassNegInclu, WZ_weight*Trigweight*B2011PUweight );
...
std::cout << "Number of Events: "<< Nevents << " Events passed BDT " << NpassBDT<< endl;
   ...
   // --- Write histograms
   TFile *target  = new TFile( "BDTCut_WZ.root","RECREATE" );
...
treeWithBDT->Delete();
   ...
   std::cout << "==> WZ_BDTCut is done!" << endl << std::endl;

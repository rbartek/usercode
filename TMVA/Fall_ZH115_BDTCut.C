 ...
 * Package   : TMVA                                                               *
 * Exectuable: Fall11_ZH115_BDTCut                                     *
 *                                                                                *
...
void Fall_ZH115_BDTCut( TString myMethodList = "" ) 
{   
#ifdef __CINT__
   ...
   std::cout << std::endl;
   std::cout << "==> Start Fall11_ZH115_BDTCut" << std::endl;
...
*/
   ...
   //   
   TFile *input(0);
   TString fname = "/home/hep/wilken/taus/CMSSW_4_4_2_patch8/src/UserCode/wilken/V21/ZH115_Fall.root"; 
	double lumi = 4.457;
	Double_t  Fall11_ZH115_weight = lumi/(2.28079234375000000e+05/xsecbfZH115); //Fall11_ZH115_TuneZ2_7TeV_pythia6_tauola
//	Double_t  Fall11_ZH115_weight = lumi/((2.28079234375000000e+05/xsecbfZH115)/2.0); 
//Fall11_ZH115_TuneZ2_7TeV_pythia6_tauola
   ...
   TTree* theTree = (TTree*)input->Get("FOM_tree");
   ...
   //   var2 = userVar1 - userVar2;
      ...
      if (Use["TMlpANN"      ])   histNnT    ->Fill( reader->EvaluateMVA( "TMlpANN method"       ) );
	   ...
	   BDTvalue = reader->EvaluateMVA( "BDT method"           );
		   histMattBdt    ->Fill( BDTvalue,Fall11_ZH115_weight*Trigweight*B2011PUweight );
		   histTMVABdt    ->Fill( BDTvalue,Fall11_ZH115_weight*Trigweight*B2011PUweight );
	   }
	  ...
	  // std::cout << "Ht is "<< Ht << endl;
	   if(BDTvalue>-1.50){
NpassBDT++;
hMjj_OpenSelection->Fill(Hmass,Fall11_ZH115_weight*Trigweight*B2011PUweight );
hMmumu_OpenSelection->Fill(Emumass,Fall11_ZH115_weight*Trigweight*B2011PUweight );
hPtjj_OpenSelection->Fill(Hpt,Fall11_ZH115_weight*Trigweight*B2011PUweight );
hPtmumu_OpenSelection->Fill(Zpt,Fall11_ZH115_weight*Trigweight*B2011PUweight );
hCSV0_OpenSelection->Fill(CSV0,Fall11_ZH115_weight*Trigweight*B2011PUweight );
hCSV1_OpenSelection->Fill(CSV1,Fall11_ZH115_weight*Trigweight*B2011PUweight );
hdphiVH_OpenSelection->Fill(DeltaPhiHV,Fall11_ZH115_weight*Trigweight*B2011PUweight );
hdetaJJ_OpenSelection->Fill(DetaJJ,Fall11_ZH115_weight*Trigweight*B2011PUweight );
hUnweightedEta_OpenSelection->Fill(UnweightedEta,Fall11_ZH115_weight*Trigweight*B2011PUweight );
hPtmu0_OpenSelection->Fill(lep0pt,Fall11_ZH115_weight*Trigweight*B2011PUweight );
	   hHt_OpenSelection->Fill(Ht,Fall11_ZH115_weight*Trigweight*B2011PUweight );
	   hCircularity_OpenSelection->Fill(EvntShpCircularity,Fall11_ZH115_weight*Trigweight*B2011PUweight );
	   hCHFb0_OpenSelection->Fill(jetCHF0, Fall11_ZH115_weight*Trigweight*B2011PUweight );
	   hCHFb1_OpenSelection->Fill(jetCHF1, Fall11_ZH115_weight*Trigweight*B2011PUweight );
	   hPtbalZH_OpenSelection->Fill(PtbalZH, Fall11_ZH115_weight*Trigweight*B2011PUweight );
	   hPtmu1_OpenSelection->Fill(lep1pt, Fall11_ZH115_weight*Trigweight*B2011PUweight );
	   hPFRelIsomu0_OpenSelection->Fill(lep_pfCombRelIso0, Fall11_ZH115_weight*Trigweight*B2011PUweight );
	   hPFRelIsomu1_OpenSelection->Fill(lep_pfCombRelIso1, Fall11_ZH115_weight*Trigweight*B2011PUweight );
	   hNjets_OpenSelection->Fill(nJets, Fall11_ZH115_weight*Trigweight*B2011PUweight );
	   hRMSeta_OpenSelection->Fill(RMS_eta, Fall11_ZH115_weight*Trigweight*B2011PUweight );
	   hStaDeveta_OpenSelection->Fill(EtaStandDev, Fall11_ZH115_weight*Trigweight*B2011PUweight );
	   hdphiJJ_vect_OpenSelection->Fill(DphiJJ, Fall11_ZH115_weight*Trigweight*B2011PUweight );
	   hCentrality_OpenSelection->Fill(Centrality, Fall11_ZH115_weight*Trigweight*B2011PUweight );
	   hEventPt_OpenSelection->Fill(EventPt, Fall11_ZH115_weight*Trigweight*B2011PUweight );
	   hAngleEMU_OpenSelection->Fill(AngleEMU, Fall11_ZH115_weight*Trigweight*B2011PUweight );
	   hSphericity_OpenSelection->Fill(EvntShpSphericity, Fall11_ZH115_weight*Trigweight*B2011PUweight );
	   hAplanarity_OpenSelection->Fill(EvntShpAplanarity, Fall11_ZH115_weight*Trigweight*B2011PUweight );
	   hIsotropy_OpenSelection->Fill(EvntShpIsotropy, Fall11_ZH115_weight*Trigweight*B2011PUweight );
		   hDphiDetajj_OpenSelection->Fill(DphiJJ, DetaJJ, Fall11_ZH115_weight*Trigweight*B2011PUweight );
		   hMte_OpenSelection->Fill(Mte, Fall11_ZH115_weight*Trigweight*B2011PUweight );
		   hMtmu_OpenSelection->Fill(Mtmu, Fall11_ZH115_weight*Trigweight*B2011PUweight );
		   hdPhiHMET_OpenSelection->Fill(dPhiHMET, Fall11_ZH115_weight*Trigweight*B2011PUweight );
		   hDphiemu_OpenSelection->Fill(DeltaPhijetMETmin, Fall11_ZH115_weight*Trigweight*B2011PUweight );
		   hdelRjj_OpenSelection->Fill(delRjj, Fall11_ZH115_weight*Trigweight*B2011PUweight );
		   hdelRemu_OpenSelection->Fill(delRemu, Fall11_ZH115_weight*Trigweight*B2011PUweight );
		   hDphiZMET_OpenSelection->Fill(DphiZMET, Fall11_ZH115_weight*Trigweight*B2011PUweight );
		   hDphiemu_OpenSelection->Fill(Dphiemu, Fall11_ZH115_weight*Trigweight*B2011PUweight );
		   hDeltaPhijetMETmin_OpenSelection->Fill(DeltaPhijetMETmin, Fall11_ZH115_weight*Trigweight*B2011PUweight );
		   hAngleHemu_OpenSelection->Fill(AngleHemu, Fall11_ZH115_weight*Trigweight*B2011PUweight );
		   hProjVisT_OpenSelection->Fill(ProjVisT, Fall11_ZH115_weight*Trigweight*B2011PUweight );
		   htopMass_OpenSelection->Fill(topMass, Fall11_ZH115_weight*Trigweight*B2011PUweight );
		   htopPt_OpenSelection->Fill(topPt, Fall11_ZH115_weight*Trigweight*B2011PUweight );
		   hVMt_OpenSelection->Fill(Mt, Fall11_ZH115_weight*Trigweight*B2011PUweight );
		   hZmassSVD_OpenSelection->Fill(ZmassSVD, Fall11_ZH115_weight*Trigweight*B2011PUweight );
		   hZmassSVDnegSol_OpenSelection->Fill(ZmassSVDnegSol, Fall11_ZH115_weight*Trigweight*B2011PUweight );
		   hZmass_OpenSelection->Fill(Zmass, Fall11_ZH115_weight*Trigweight*B2011PUweight );
		   hZmassNegInclu_OpenSelection->Fill(ZmassNegInclu, Fall11_ZH115_weight*Trigweight*B2011PUweight );
...
std::cout << "Number of Events: "<< Nevents << " Events passed BDT " << NpassBDT<< endl;
   ...
   // --- Write histograms
   TFile *target  = new TFile( "BDTCut_Fall11_ZH115.root","RECREATE" );
...
treeWithBDT->Delete();
   ...
   std::cout << "==> Fall11_ZH115_BDTCut is done!" << endl << std::endl;

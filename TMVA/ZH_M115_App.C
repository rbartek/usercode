...
void ZH_M115_App( TString myMethodList = "" ) 
{   
#ifdef __CINT__
   ...
   std::cout << std::endl;
   std::cout << "==> Start ZH_M115_App" << std::endl;
...
*/
   ...
   for (std::map<std::string,int>::iterator it = Use.begin(); it != Use.end(); it++) {
	...
	treeWithBDT->Branch("Naj",&Naj, "Naj/I");
	treeWithBDT->Branch("eventFlavor",&eventFlavor, "eventFlavor/F");
...
if (Use["BDTD"])          histBdtD    = new TH1F( "MVA_BDTD",          "MVA_BDTD",          nbin, -0.8, 0.8 );
   ...
   //   
   TFile *input(0);
   TString fname = "/home/hep/wilken/Weights/CMSSW_4_2_8_patch3/src/UserCode/wilken/CSVShapeCorr/ZH_M115.root"; 
   double lumi = 100.0;
   ...
   //   var2 = userVar1 - userVar2;
      ...
      if (Use["TMlpANN"      ])   histNnT    ->Fill( reader->EvaluateMVA( "TMlpANN method"       ) );
	   if (Use["BDT"          ]) {
		   ...
		   histMattBdt    ->Fill( BDTvalue,ZH_M115_weight );
		   histTMVABdt    ->Fill( BDTvalue,ZH_M115_weight );
	   }
...
hMjj_OpenSelection->Fill(Hmass,ZH_M115_weight);
hMmumu_OpenSelection->Fill(Zmass,ZH_M115_weight);
hPtjj_OpenSelection->Fill(Hpt,ZH_M115_weight);
hPtmumu_OpenSelection->Fill(Zpt,ZH_M115_weight);
hCSV0_OpenSelection->Fill(CSV0,ZH_M115_weight);
hCSV1_OpenSelection->Fill(CSV1,ZH_M115_weight);
hdphiVH_OpenSelection->Fill(DeltaPhiHV,ZH_M115_weight);
hdetaJJ_OpenSelection->Fill(DetaJJ,ZH_M115_weight);
hUnweightedEta_OpenSelection->Fill(UnweightedEta,ZH_M115_weight);
hPtmu0_OpenSelection->Fill(mu0pt,ZH_M115_weight);
	   hHt_OpenSelection->Fill(Ht,ZH_M115_weight);
	   hCircularity_OpenSelection->Fill(EvntShpCircularity,ZH_M115_weight);
	   hCHFb0_OpenSelection->Fill(jetCHF0, ZH_M115_weight);
	   hCHFb1_OpenSelection->Fill(jetCHF1, ZH_M115_weight);
	   hPtbalZH_OpenSelection->Fill(PtbalZH, ZH_M115_weight);
	   hPtmu1_OpenSelection->Fill(mu1pt, ZH_M115_weight);
	   hPFRelIsomu0_OpenSelection->Fill(muonPFiso0, ZH_M115_weight);
	   hPFRelIsomu1_OpenSelection->Fill(muonPFiso1, ZH_M115_weight);
	   hNjets_OpenSelection->Fill(nJets, ZH_M115_weight);
	   hRMSeta_OpenSelection->Fill(RMS_eta, ZH_M115_weight);
	   hStaDeveta_OpenSelection->Fill(EtaStandDev, ZH_M115_weight);
	   hdphiJJ_vect_OpenSelection->Fill(DphiJJ, ZH_M115_weight);
	   hCentrality_OpenSelection->Fill(Centrality, ZH_M115_weight);
	   hEventPt_OpenSelection->Fill(EventPt, ZH_M115_weight);
	   hAngle_OpenSelection->Fill(Angle, ZH_M115_weight);
	   hSphericity_OpenSelection->Fill(EvntShpSphericity, ZH_M115_weight);
	   hAplanarity_OpenSelection->Fill(EvntShpAplanarity, ZH_M115_weight);
	   hIsotropy_OpenSelection->Fill(EvntShpIsotropy, ZH_M115_weight);
	   hDphiDetajj_OpenSelection->Fill(DphiJJ, DetaJJ, ZH_M115_weight);
   ...
   TFile *target  = new TFile( "TMVApp_ZH_M115.root","RECREATE" );
...
treeWithBDT->Delete();
   ...
   std::cout << "==> ZH_M115_App is done!" << endl << std::endl;

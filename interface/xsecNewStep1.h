...
const double numWJ = 11111111111111111;
const double numZJH = 1.16363537500000000e+06;
const double numZJL = 1.68163360000000000e+07;
const double numTT = 5.40391000000000000e+07;
//TTbar_M60
//TTbar 3803462.25;
const double numTs = 1111111111;
const double numTt = 1111111111111;
const double numTtW = 111111111111111;
const double numTsb = 11111111111;
const double numTtb = 1992339.75;
const double numTtWb = 11111111111;
const double numWW = 1.65463750000000000e+06;
const double numWZ = 11111111111111;
const double numZH100 = 1111111111;
const double numZH105 = 219999.0;
const double numZH110 = 218777.0;
const double numZH115 = 1.03832125000000000e+06;
...
const double numZZ = 11111111111;

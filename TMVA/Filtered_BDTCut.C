...
void Filtered_BDTCut( TString myMethodList = "" ) 
{   
#ifdef __CINT__
   ...
   std::cout << std::endl;
   std::cout << "==> Start ZH_M115_BDTCut" << std::endl;
...
*/
   ...
   //   
   TFile *input(0);
   TString fname = "/home/hep/wilken/taus/CMSSW_4_4_2_patch8/src/UserCode/wilken/V21/Filteredemu.root"; 
	double lumi = 4.457;
	Double_t  ZH_M115_weight = lumi/(lumiZH115/2.0); //ZH_M115_TuneZ2_7TeV_pythia6_tauola
   ...
   //   var2 = userVar1 - userVar2;
      ...
      if (Use["TMlpANN"      ])   histNnT    ->Fill( reader->EvaluateMVA( "TMlpANN method"       ) );
	   ...
	   BDTvalue = reader->EvaluateMVA( "BDT method"           );
		   histMattBdt    ->Fill( BDTvalue,ZH_M115_weight*Trigweight*B2011PUweight );
		   histTMVABdt    ->Fill( BDTvalue,ZH_M115_weight*Trigweight*B2011PUweight );
	   }
	  ...
	  // std::cout << "Ht is "<< Ht << endl;
	   if(BDTvalue>-1.50){
NpassBDT++;
hMjj_OpenSelection->Fill(Hmass,ZH_M115_weight*Trigweight*B2011PUweight );
hMmumu_OpenSelection->Fill(Emumass,ZH_M115_weight*Trigweight*B2011PUweight );
hPtjj_OpenSelection->Fill(Hpt,ZH_M115_weight*Trigweight*B2011PUweight );
hPtmumu_OpenSelection->Fill(Zpt,ZH_M115_weight*Trigweight*B2011PUweight );
hCSV0_OpenSelection->Fill(CSV0,ZH_M115_weight*Trigweight*B2011PUweight );
hCSV1_OpenSelection->Fill(CSV1,ZH_M115_weight*Trigweight*B2011PUweight );
hdphiVH_OpenSelection->Fill(DeltaPhiHV,ZH_M115_weight*Trigweight*B2011PUweight );
hdetaJJ_OpenSelection->Fill(DetaJJ,ZH_M115_weight*Trigweight*B2011PUweight );
hUnweightedEta_OpenSelection->Fill(UnweightedEta,ZH_M115_weight*Trigweight*B2011PUweight );
hPtmu0_OpenSelection->Fill(lep0pt,ZH_M115_weight*Trigweight*B2011PUweight );
	   hHt_OpenSelection->Fill(Ht,ZH_M115_weight*Trigweight*B2011PUweight );
	   hCircularity_OpenSelection->Fill(EvntShpCircularity,ZH_M115_weight*Trigweight*B2011PUweight );
	   hCHFb0_OpenSelection->Fill(jetCHF0, ZH_M115_weight*Trigweight*B2011PUweight );
	   hCHFb1_OpenSelection->Fill(jetCHF1, ZH_M115_weight*Trigweight*B2011PUweight );
	   hPtbalZH_OpenSelection->Fill(PtbalZH, ZH_M115_weight*Trigweight*B2011PUweight );
	   hPtmu1_OpenSelection->Fill(lep1pt, ZH_M115_weight*Trigweight*B2011PUweight );
	   hPFRelIsomu0_OpenSelection->Fill(lep_pfCombRelIso0, ZH_M115_weight*Trigweight*B2011PUweight );
	   hPFRelIsomu1_OpenSelection->Fill(lep_pfCombRelIso1, ZH_M115_weight*Trigweight*B2011PUweight );
	   hNjets_OpenSelection->Fill(nJets, ZH_M115_weight*Trigweight*B2011PUweight );
	   hRMSeta_OpenSelection->Fill(RMS_eta, ZH_M115_weight*Trigweight*B2011PUweight );
	   hStaDeveta_OpenSelection->Fill(EtaStandDev, ZH_M115_weight*Trigweight*B2011PUweight );
	   hdphiJJ_vect_OpenSelection->Fill(DphiJJ, ZH_M115_weight*Trigweight*B2011PUweight );
	   hCentrality_OpenSelection->Fill(Centrality, ZH_M115_weight*Trigweight*B2011PUweight );
	   hEventPt_OpenSelection->Fill(EventPt, ZH_M115_weight*Trigweight*B2011PUweight );
	   hAngleEMU_OpenSelection->Fill(AngleEMU, ZH_M115_weight*Trigweight*B2011PUweight );
	   hSphericity_OpenSelection->Fill(EvntShpSphericity, ZH_M115_weight*Trigweight*B2011PUweight );
	   hAplanarity_OpenSelection->Fill(EvntShpAplanarity, ZH_M115_weight*Trigweight*B2011PUweight );
	   hIsotropy_OpenSelection->Fill(EvntShpIsotropy, ZH_M115_weight*Trigweight*B2011PUweight );
		   hDphiDetajj_OpenSelection->Fill(DphiJJ, DetaJJ, ZH_M115_weight*Trigweight*B2011PUweight );
		   hMte_OpenSelection->Fill(Mte, ZH_M115_weight*Trigweight*B2011PUweight );
		   hMtmu_OpenSelection->Fill(Mtmu, ZH_M115_weight*Trigweight*B2011PUweight );
		   hdPhiHMET_OpenSelection->Fill(dPhiHMET, ZH_M115_weight*Trigweight*B2011PUweight );
		   hDphiemu_OpenSelection->Fill(DeltaPhijetMETmin, ZH_M115_weight*Trigweight*B2011PUweight );
		   hdelRjj_OpenSelection->Fill(delRjj, ZH_M115_weight*Trigweight*B2011PUweight );
		   hdelRemu_OpenSelection->Fill(delRemu, ZH_M115_weight*Trigweight*B2011PUweight );
		   hDphiZMET_OpenSelection->Fill(DphiZMET, ZH_M115_weight*Trigweight*B2011PUweight );
		   hDphiemu_OpenSelection->Fill(Dphiemu, ZH_M115_weight*Trigweight*B2011PUweight );
		   hDeltaPhijetMETmin_OpenSelection->Fill(DeltaPhijetMETmin, ZH_M115_weight*Trigweight*B2011PUweight );
		   hAngleHemu_OpenSelection->Fill(AngleHemu, ZH_M115_weight*Trigweight*B2011PUweight );
		   hProjVisT_OpenSelection->Fill(ProjVisT, ZH_M115_weight*Trigweight*B2011PUweight );
		   htopMass_OpenSelection->Fill(topMass, ZH_M115_weight*Trigweight*B2011PUweight );
		   htopPt_OpenSelection->Fill(topPt, ZH_M115_weight*Trigweight*B2011PUweight );
		   hVMt_OpenSelection->Fill(Mt, ZH_M115_weight*Trigweight*B2011PUweight );
		   hZmassSVD_OpenSelection->Fill(ZmassSVD, ZH_M115_weight*Trigweight*B2011PUweight );
		   hZmassSVDnegSol_OpenSelection->Fill(ZmassSVDnegSol, ZH_M115_weight*Trigweight*B2011PUweight );
		   hZmass_OpenSelection->Fill(Zmass, ZH_M115_weight*Trigweight*B2011PUweight );
		   hZmassNegInclu_OpenSelection->Fill(ZmassNegInclu, ZH_M115_weight*Trigweight*B2011PUweight );
...
std::cout << "Number of Events: "<< Nevents << " Events passed BDT " << NpassBDT<< endl;
   ...
   // --- Write histograms
   TFile *target  = new TFile( "BDTCut_Filteredemu.root","RECREATE" );
...
treeWithBDT->Delete();
   ...
   std::cout << "==> ZH_M115_BDTCut is done!" << endl << std::endl;

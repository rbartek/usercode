...
void WJets_BDTCut( TString myMethodList = "" ) 
{   
#ifdef __CINT__
   ...
   std::cout << std::endl;
   std::cout << "==> Start WJets_BDTCut" << std::endl;
...
*/
   ...
   //   
   TFile *input(0);
   TString fname = "/home/hep/wilken/taus/CMSSW_4_4_2_patch8/src/UserCode/wilken/V21/WJets.root"; 
	double lumi = 4.457;
	Double_t  WJets_weight = lumi/(lumiWJ/2.0); //WJets_TuneZ2_7TeV_pythia6_tauola
   ...
   //   var2 = userVar1 - userVar2;
      ...
      if (Use["TMlpANN"      ])   histNnT    ->Fill( reader->EvaluateMVA( "TMlpANN method"       ) );
	   ...
	   BDTvalue = reader->EvaluateMVA( "BDT method"           );
		   histMattBdt    ->Fill( BDTvalue,WJets_weight*Trigweight*B2011PUweight );
		   histTMVABdt    ->Fill( BDTvalue,WJets_weight*Trigweight*B2011PUweight );
	   }
	  ...
	  // std::cout << "Ht is "<< Ht << endl;
	   if(BDTvalue>-1.50){
NpassBDT++;
hMjj_OpenSelection->Fill(Hmass,WJets_weight*Trigweight*B2011PUweight );
hMmumu_OpenSelection->Fill(Emumass,WJets_weight*Trigweight*B2011PUweight );
hPtjj_OpenSelection->Fill(Hpt,WJets_weight*Trigweight*B2011PUweight );
hPtmumu_OpenSelection->Fill(Zpt,WJets_weight*Trigweight*B2011PUweight );
hCSV0_OpenSelection->Fill(CSV0,WJets_weight*Trigweight*B2011PUweight );
hCSV1_OpenSelection->Fill(CSV1,WJets_weight*Trigweight*B2011PUweight );
hdphiVH_OpenSelection->Fill(DeltaPhiHV,WJets_weight*Trigweight*B2011PUweight );
hdetaJJ_OpenSelection->Fill(DetaJJ,WJets_weight*Trigweight*B2011PUweight );
hUnweightedEta_OpenSelection->Fill(UnweightedEta,WJets_weight*Trigweight*B2011PUweight );
hPtmu0_OpenSelection->Fill(lep0pt,WJets_weight*Trigweight*B2011PUweight );
	   hHt_OpenSelection->Fill(Ht,WJets_weight*Trigweight*B2011PUweight );
	   hCircularity_OpenSelection->Fill(EvntShpCircularity,WJets_weight*Trigweight*B2011PUweight );
	   hCHFb0_OpenSelection->Fill(jetCHF0, WJets_weight*Trigweight*B2011PUweight );
	   hCHFb1_OpenSelection->Fill(jetCHF1, WJets_weight*Trigweight*B2011PUweight );
	   hPtbalZH_OpenSelection->Fill(PtbalZH, WJets_weight*Trigweight*B2011PUweight );
	   hPtmu1_OpenSelection->Fill(lep1pt, WJets_weight*Trigweight*B2011PUweight );
	   hPFRelIsomu0_OpenSelection->Fill(lep_pfCombRelIso0, WJets_weight*Trigweight*B2011PUweight );
	   hPFRelIsomu1_OpenSelection->Fill(lep_pfCombRelIso1, WJets_weight*Trigweight*B2011PUweight );
	   hNjets_OpenSelection->Fill(nJets, WJets_weight*Trigweight*B2011PUweight );
	   hRMSeta_OpenSelection->Fill(RMS_eta, WJets_weight*Trigweight*B2011PUweight );
	   hStaDeveta_OpenSelection->Fill(EtaStandDev, WJets_weight*Trigweight*B2011PUweight );
	   hdphiJJ_vect_OpenSelection->Fill(DphiJJ, WJets_weight*Trigweight*B2011PUweight );
	   hCentrality_OpenSelection->Fill(Centrality, WJets_weight*Trigweight*B2011PUweight );
	   hEventPt_OpenSelection->Fill(EventPt, WJets_weight*Trigweight*B2011PUweight );
	   hAngleEMU_OpenSelection->Fill(AngleEMU, WJets_weight*Trigweight*B2011PUweight );
	   hSphericity_OpenSelection->Fill(EvntShpSphericity, WJets_weight*Trigweight*B2011PUweight );
	   hAplanarity_OpenSelection->Fill(EvntShpAplanarity, WJets_weight*Trigweight*B2011PUweight );
	   hIsotropy_OpenSelection->Fill(EvntShpIsotropy, WJets_weight*Trigweight*B2011PUweight );
		   hDphiDetajj_OpenSelection->Fill(DphiJJ, DetaJJ, WJets_weight*Trigweight*B2011PUweight );
		   hMte_OpenSelection->Fill(Mte, WJets_weight*Trigweight*B2011PUweight );
		   hMtmu_OpenSelection->Fill(Mtmu, WJets_weight*Trigweight*B2011PUweight );
		   hdPhiHMET_OpenSelection->Fill(dPhiHMET, WJets_weight*Trigweight*B2011PUweight );
		   hDphiemu_OpenSelection->Fill(DeltaPhijetMETmin, WJets_weight*Trigweight*B2011PUweight );
		   hdelRjj_OpenSelection->Fill(delRjj, WJets_weight*Trigweight*B2011PUweight );
		   hdelRemu_OpenSelection->Fill(delRemu, WJets_weight*Trigweight*B2011PUweight );
		   hDphiZMET_OpenSelection->Fill(DphiZMET, WJets_weight*Trigweight*B2011PUweight );
		   hDphiemu_OpenSelection->Fill(Dphiemu, WJets_weight*Trigweight*B2011PUweight );
		   hDeltaPhijetMETmin_OpenSelection->Fill(DeltaPhijetMETmin, WJets_weight*Trigweight*B2011PUweight );
		   hAngleHemu_OpenSelection->Fill(AngleHemu, WJets_weight*Trigweight*B2011PUweight );
		   hProjVisT_OpenSelection->Fill(ProjVisT, WJets_weight*Trigweight*B2011PUweight );
		   htopMass_OpenSelection->Fill(topMass, WJets_weight*Trigweight*B2011PUweight );
		   htopPt_OpenSelection->Fill(topPt, WJets_weight*Trigweight*B2011PUweight );
		   hVMt_OpenSelection->Fill(Mt, WJets_weight*Trigweight*B2011PUweight );
		   hZmassSVD_OpenSelection->Fill(ZmassSVD, WJets_weight*Trigweight*B2011PUweight );
		   hZmassSVDnegSol_OpenSelection->Fill(ZmassSVDnegSol, WJets_weight*Trigweight*B2011PUweight );
		   hZmass_OpenSelection->Fill(Zmass, WJets_weight*Trigweight*B2011PUweight );
		   hZmassNegInclu_OpenSelection->Fill(ZmassNegInclu, WJets_weight*Trigweight*B2011PUweight );
...
std::cout << "Number of Events: "<< Nevents << " Events passed BDT " << NpassBDT<< endl;
   ...
   // --- Write histograms
   TFile *target  = new TFile( "BDTCut_WJets.root","RECREATE" );
...
treeWithBDT->Delete();
   ...
   std::cout << "==> WJets_BDTCut is done!" << endl << std::endl;

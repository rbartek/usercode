    ...
    do {
		...
		if (((isM50sample && sample.genZpt < 100) || !isM50sample) && ((HFfile && sample.eventFlav == 5)||!HFfile) && ((LFfile && sample.eventFlav!=5)||!LFfile)){
			...
			if (sample.Vtype == 5 && sample.EVENT_json == 1 ){
				...
				qtlep1 = 0.0, alpha_lep = -99.99, genPt_1hJet = -99.99, genPt_0hJet = -99.99, genPtReg0_hJet = -99.99, genPtReg1_hJet = -99.99;
				Pt0_hJet = -99.99, Pt1_hJet = -99.99;
				...
				genPt_0hJet = sample.hJet_genPt[0];
				genPtReg0_hJet = sample.hJet_genPtReg0;
				Pt0_hJet = sample.hJet_pt[0];
				...
				if (sample.nhJets > 1) { 
					...
					genPt_1hJet = sample.hJet_genPt[1];
					genPtReg1_hJet = sample.hJet_genPtReg1;
					Pt1_hJet = sample.hJet_pt[1];
				...
				if ((sample.vLepton_pt[1] > 20 || sample.vLepton_pt[0] > 20) && (sample.vLepton_pt[1]>10 && sample.vLepton_pt[0]> 10)){
					...
					if ( jetPt[0] > 20 && jetPt[1] > 20 && Hmass<300 &&
						...
						if (fabs(DphiZMET) < 0.45 && (Hmass>=80)&&(Hmass<=170) && CSV0>0.4 && DeltaPhiHV > 1.6 && Pzeta > 10 && Emumass< 120  && jetCHF[0]>0.12) hdelRemu_NotThisCut.Fill(delRemu, weight);
						if(delRemu>0.4){
							...
							FOM_tree->Fill();
							if (fabs(DphiZMET) < 0.45 && (Hmass>=80)&&(Hmass<=170) && CSV0>0.4 && DeltaPhiHV > 1.6 && Pzeta > 10 && jetCHF[0]>0.12) hMemu_NotThisCut.Fill(Emumass, weight);
							if (Emumass< 120 ) { 
								...
								if (fabs(DphiSecondMET) < 1.5 && (Hmass>40)&&(Hmass<=170) && DeltaPhiHV > 1.6 && CSV0<0.4 && Naj < 2 && nSV ==0){	
								...
								if (fabs(DphiZMET) < 0.45 && (Hmass>=80)&&(Hmass<=170) && DeltaPhiHV > 1.6 && jetCHF[0]>0.12 && Pzeta > 10) hCSV0_NotThisCut.Fill(CSV0, weight);							
								if(CSV0>0.4){
								...
								//	EventDistributions("CSV0", weight);							
									if (fabs(DphiZMET) > 0.45 && (Hmass>40)&&(Hmass<=170) && DeltaPhiHV > 1.6 && jetCHF[0]>0.12 ){
										if (Hmass>60 ){
								...
								//				EventDistributions("SingleTopCR", weight);
									...
									if ((Hmass>=80)&&(Hmass<=170) && DeltaPhiHV > 1.6 && Pzeta > 10 && jetCHF[0]>0.12) hDphiZMET_NotThisCut.Fill(DphiZMET, weight);
									if (fabs(DphiZMET) < 0.45){
								...
								//		EventDistributions("DphiZMET", weight);
										if ((Hmass>=80)&&(Hmass<=170) && Pzeta > 10 && jetCHF[0]>0.12) hDeltaPhiHV_NotThisCut.Fill(DeltaPhiHV, weight);
										if (DeltaPhiHV > 1.6){
								...
								//			EventDistributions("DeltaPhiHV", weight);
											if ((Hmass>=80)&&(Hmass<=170) && jetCHF[0]>0.12) hPzeta_NotThisCut.Fill(Pzeta, weight);
											if (Pzeta > 10){
								...
								///				LeptonDistributions("Pzeta", weight);
									...
									//			EventDistributions("Pzeta", weight);												
												if (Naj<2) hMjj_NotThisCut.Fill(Hmass, weight);
												if((Hmass>=80)&&(Hmass<=170)){
									...
									//					EventDistributions("CHF0", weight);
												...
												if ((Hmass<80 || Hmass>170) && Hmass < 250 ){
													if (fabs(DphiZMET) < 0.45 && Mte < 95 && Mtmu < 135 && ScalarSumPt < 150 && fabs(Dphiemu)<2.0){
...
void JetDistributions(string cut, double ph_weight){
	...
	if (!isdata) fillhisto(RegRes, GenHiggsMass-RegHmass, ph_weight, "Resoltuion Higgs Regressed", 100, -1, 1);
	if (!isdata) fillhisto(RecoRes, GenHiggsMass-oldHmass, ph_weight, "Recolution Higgs Reco", 100, -1, 1);
	if (!isdata) fillhisto(Regb0Res, genPt_0hJet-genPtReg0_hJet, ph_weight, "Resoltuion jet 0 Regressed", 100, -1, 1);
	if (!isdata) fillhisto(Recob0Res, genPt_0hJet-Pt0_hJet, ph_weight, "Recolution jet 0 Reco", 100, -1, 1);
	if (!isdata) fillhisto(Regb1Res, genPt_1hJet-genPtReg1_hJet, ph_weight, "Resoltuion jet 1 Regressed", 100, -1, 1);
	if (!isdata) fillhisto(Recob1Res, genPt_1hJet-Pt1_hJet, ph_weight, "Recolution jet 1 Reco", 100, -1, 1);
}

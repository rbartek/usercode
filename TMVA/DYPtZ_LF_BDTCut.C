...
void DYPtZ_LF_BDTCut( TString myMethodList = "" ) 
{   
#ifdef __CINT__
   ...
   std::cout << std::endl;
   std::cout << "==> Start DYPtZ_LF_BDTCut" << std::endl;
...
std::cout << "Number of Events: "<< Nevents << " Events passed BDT " << NpassBDT<< endl;
   ...
   // --- Write histograms
   TFile *target  = new TFile( "BDTCut_DYPtZ_LF.root","RECREATE" );
...
treeWithBDT->Delete();
   ...
   std::cout << "==> DYPtZ_LF_BDTCut is done!" << endl << std::endl;

 ...
 * Package   : TMVA                                                               *
 * Exectuable: DYJetsToLL_M50_App_bflavor                                     *
 *                                                                                *
...
void DYJetsToLL_M50_App_bflavor( TString myMethodList = "" ) 
{   
#ifdef __CINT__
   ...
   std::cout << std::endl;
   std::cout << "==> Start DYJetsToLL_M50_App_bflavor" << std::endl;
...
*/
   ...
   //   
   TFile *input(0);
   TString fname = "/home/hep/wilken/Weights/CMSSW_4_2_8_patch3/src/UserCode/wilken/CSVShapeCorr/DYJetsToLL_M50.root"; 
	double lumi = 100.0;
	Double_t  DYJetsToLL_M50_weight = lumi/(lumiZJL/2.0) ; //DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola
	//DYJetsToLL_M50_weight = DYJetsToLL_M50_weight* (11470	/ 120377.0) ;
   ...
   std::vector<Float_t> vecVar(4); // vector for EvaluateMVA tests
	...
	DYJetsToLL_M50_weight = DYJetsToLL_M50_weight* ( NumInTree /float(NumberTMVAtree)) ;
 ...
 //     var1 = userVar1 + userVar2;
   //   var2 = userVar1 - userVar2;
	  ...
	  // std::cout << "Ht is "<< Ht << endl;
	   if (eventFlavor == 5 ) {
		   histMattBdt    ->Fill( BDTvalue,DYJetsToLL_M50_weight );
		   histTMVABdt    ->Fill( BDTvalue,DYJetsToLL_M50_weight );
hMjj_OpenSelection->Fill(Hmass,DYJetsToLL_M50_weight);
hMmumu_OpenSelection->Fill(Zmass,DYJetsToLL_M50_weight);
hPtjj_OpenSelection->Fill(Hpt,DYJetsToLL_M50_weight);
hPtmumu_OpenSelection->Fill(Zpt,DYJetsToLL_M50_weight);
hCSV0_OpenSelection->Fill(CSV0,DYJetsToLL_M50_weight);
hCSV1_OpenSelection->Fill(CSV1,DYJetsToLL_M50_weight);
hdphiVH_OpenSelection->Fill(DeltaPhiHV,DYJetsToLL_M50_weight);
hdetaJJ_OpenSelection->Fill(DetaJJ,DYJetsToLL_M50_weight);
hUnweightedEta_OpenSelection->Fill(UnweightedEta,DYJetsToLL_M50_weight);
hPtmu0_OpenSelection->Fill(mu0pt,DYJetsToLL_M50_weight);
	   hHt_OpenSelection->Fill(Ht,DYJetsToLL_M50_weight);
	   hCircularity_OpenSelection->Fill(EvntShpCircularity,DYJetsToLL_M50_weight);
	   hCHFb0_OpenSelection->Fill(jetCHF0, DYJetsToLL_M50_weight);
	   hCHFb1_OpenSelection->Fill(jetCHF1, DYJetsToLL_M50_weight);
	   hPtbalZH_OpenSelection->Fill(PtbalZH, DYJetsToLL_M50_weight);
	   hPtmu1_OpenSelection->Fill(mu1pt, DYJetsToLL_M50_weight);
	   hPFRelIsomu0_OpenSelection->Fill(muonPFiso0, DYJetsToLL_M50_weight);
	   hPFRelIsomu1_OpenSelection->Fill(muonPFiso1, DYJetsToLL_M50_weight);
	   hNjets_OpenSelection->Fill(nJets, DYJetsToLL_M50_weight);
	   hRMSeta_OpenSelection->Fill(RMS_eta, DYJetsToLL_M50_weight);
	   hStaDeveta_OpenSelection->Fill(EtaStandDev, DYJetsToLL_M50_weight);
	   hdphiJJ_vect_OpenSelection->Fill(DphiJJ, DYJetsToLL_M50_weight);
	   hCentrality_OpenSelection->Fill(Centrality, DYJetsToLL_M50_weight);
	   hEventPt_OpenSelection->Fill(EventPt, DYJetsToLL_M50_weight);
	   hAngle_OpenSelection->Fill(Angle, DYJetsToLL_M50_weight);
	   hSphericity_OpenSelection->Fill(EvntShpSphericity, DYJetsToLL_M50_weight);
	   hAplanarity_OpenSelection->Fill(EvntShpAplanarity, DYJetsToLL_M50_weight);
	   hIsotropy_OpenSelection->Fill(EvntShpIsotropy, DYJetsToLL_M50_weight);
	   hDphiDetajj_OpenSelection->Fill(DphiJJ, DetaJJ, DYJetsToLL_M50_weight);
   ...
   TFile *target  = new TFile( "TMVApp_DYJetsToLL_M50_bflavor.root","RECREATE" );
...
treeWithBDT->Delete();
   ...
   std::cout << "==> DYJetsToLL_M50_App_bflavor is done!" << endl << std::endl;
